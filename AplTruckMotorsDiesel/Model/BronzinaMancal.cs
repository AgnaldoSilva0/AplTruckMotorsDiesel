...
namespace AplTruckMotorsDiesel.Model
{
    class BronzinaMancal
    {
        ...
        public BronzinaMancal(string id, string codigoBMancal, string codigoOriginal, string marca, string observacao)
        {
            this.id = id;
            this.codigoBMancal = codigoBMancal;
        ...
        public static BronzinaMancal retornaFichaTecnicaPorCodigo(string codigo)
        {
            ...
            try
            {
                ...
                {
                    bronzinaMancal = new BronzinaMancal(Convert.ToString(row["id"]),
